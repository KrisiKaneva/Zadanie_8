...
namespace Zadanie_8
{
    internal class Program
    {
        ...
        //3
        //public static void SearchProduct(OnlineStore store)
        //{
        //    Console.WriteLine("How would you like to search for the product");
        //    Console.WriteLine("Available answers: By name/ By category");
        //    string choice = Console.ReadLine();
        //    switch (choice)
        //    {
        //        case "By name":
        ...
        //            string name = Console.ReadLine();
        //            var products1 = store.SearchProductByName(name);
        ...
        //            break;
        //        case "By category":
        //            Console.WriteLine("Въведете категорията на продукта за търсене:");
        //            string category = Console.ReadLine();
        //            var products2 = store.SearchProductByCategory(category);
